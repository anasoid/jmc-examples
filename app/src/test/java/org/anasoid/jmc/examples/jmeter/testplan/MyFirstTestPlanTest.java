...
class MyFirstTestPlanTest {

  @Test
  void firstTest() throws IOException {

    ApplicationTest applicationTest = new ApplicationTest(new MyFirstTestPlan().getTestPlan());

    String filepath =
        System.getProperties().getProperty("user.dir") + "/build/jmx/" + "firstTest.jmx";
