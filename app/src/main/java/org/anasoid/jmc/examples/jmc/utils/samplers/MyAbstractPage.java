...
public abstract class MyAbstractPage extends SimplePageTemplate {


  public MyAbstractPage(@NonNull String name, @NonNull String path) {
    super(name, path);
  }

  public MyAbstractPage(@NonNull String name, @NonNull String path, String domain) {
